...
import { Equity, OracleFreeDollar, StablecoinBridge, TestToken } from "../typechain";
...
describe("Equity Tests", () => {
  ...
  describe("basic initialization", () => {
    ...
    it("should have symbol OFDPS", async () => {
      ...
      expect(symbol).to.be.equal("OFDPS");
    });
  ...
  describe("minting shares", () => {
    ...
    //   await xofd.mint(owner.address, amount);
    //   await xofd.approve(await bridge.getAddress(), amount);
